...
DataArray(LevelEndPosition, SonicMission12EndArray, 0x174A280, 9);
DataArray(LevelEndPosition, ShadowMission12EndArray, 0x174A3A0, 6);
DataArray(LevelEndPosition, KnucklesMission12EndArray, 0x174A460, 7);
DataArray(LevelEndPosition, RougeMission12EndArray, 0x174A540, 6);
DataArray(LevelEndPosition, MechEggmanMission12EndArray, 0x174A600, 7);
DataArray(LevelEndPosition, MechTailsMission12EndArray, 0x174A6E0, 6);
