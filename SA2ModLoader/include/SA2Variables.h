...
DataArray(LightData, ChaoHealthCenter_DefaultLights, 0x8A297C, 2);
DataPointer(LightData, ChaoBlackMarket_DefaultLight, 0x8A3638);
...
DataArray(RewardScreen, RewardScreenTextArray, 0x96A900, 20);
DataPointer(LightData, EmblemScreen_DefaultLight, 0x96E6FC);
DataArray(MenuVoices, MenuVoiceArray, 0x96E728, 28);
DataArray(ActionWindowTextArray, CommonActionWindowTextIndexes, 0x96EBF8, 17);
DataArray(ActionWindowTextArray, SonicActionWindowTextIndexes, 0x96EC80, 10);
DataArray(ActionWindowTextArray, AmyActionWindowTextIndexes, 0x96ECD0, 9);
DataArray(ActionWindowTextArray, ShadowActionWindowTextIndexes, 0x96ED18, 8);
DataArray(ActionWindowTextArray, KnucklesActionWindowTextIndexes, 0x96ED58, 12);
DataArray(ActionWindowTextArray, TikalActionWindowTextIndexes, 0x96EDB8, 11);
DataArray(ActionWindowTextArray, RougeActionWindowTextIndexes, 0x96EE10, 14);
DataArray(ActionWindowTextArray, ChaosActionWindowTextIndexes, 0x96EE80, 11);
DataArray(ActionWindowTextArray, MechEggmanActionWindowTextIndexes, 0x96EED8, 6);
DataArray(ActionWindowTextArray, DarkChaoWalkerActionWindowTextIndexes, 0x96EF08, 6);
DataArray(ActionWindowTextArray, MechTailsActionWindowTextIndexes, 0x96EF38, 6);
DataArray(ActionWindowTextArray, ChaoWalkerActionWindowTextIndexes, 0x96EF68, 6);
DataArray(ActionWindowTextArray, EggmanActionWindowTextIndexes, 0x96EF98, 2);
DataArray(ActionWindowTextArray, TailsActionWindowTextIndexes, 0x96EFA8, 2);
...
DataPointer(DeathZone, MissionStreet2P_DeathZone, 0x9709E8);
DataPointer(LevelHeader, MissionStreet2PHeader, 0x9709F8);
DataPointer(LevelHeader, EndingHeader, 0x970A10);
DataPointer(DeathZone, DeckRace_DeathZone, 0x972174);
DataArray(LightData, DeckRace_DefaultLights, 0x972190, 2);
...
DataArray(DeathZone, EternalEngine_DeathZones, 0x9A153C, 5);
DataArray(LightData, EternalEngine_DefaultLights, 0x9A1578, 2);
DataArray(ChunkMapColor, EternalEngine_ChunkColors, 0x9A15D0, 13);
...
DataArray(DeathZone, CrazyGadget_DeathZones, 0x9C8178, 9);
DataArray(LightData, CrazyGadget_DefaultLights, 0x9C81C8, 2);
DataPointer(LevelHeader, CrazyGadgetHeader, 0x9C8208);
DataArray(ChunkMapColor, CrazyGadget_ChunkColors, 0x9C8220, 13);
DataPointer(AnimationIndex, WeaponsBedCharAnims, 0x9CBEC8);
DataPointer(DeathZone, WeaponsBed_DeathZone, 0x9ED904);
DataArray(LightData, WeaponsBed_DefaultLights, 0x9ED950, 2);
DataPointer(LevelHeader, WeaponsBedHeader, 0x9ED990);
DataPointer(AnimationIndex, LostColonyCharAnims, 0x9F4654);
DataArray(DeathZone, LostColony_DeathZones, 0xA06CB0, 4);
DataArray(LightData, LostColony_DefaultLights, 0xA06CD8, 2);
DataPointer(LevelHeader, LostColonyHeader, 0xA06D18);
DataArray(ChunkMapColor, LostColony_ChunkColors, 0xA06D30, 9);
...
DataArray(DeathZone, HiddenBase_DeathZones, 0xA98528, 7);
DataArray(LightData, HiddenBase_DefaultLights, 0xA98568, 2); // Unreferenced
DataPointer(LevelHeader, HiddenBaseHeader, 0xA985A8);
DataArray(AnimationIndex, PyramidCaveCharAnims, 0xADB270, 9);
DataArray(DeathZone, PyramidCave_DeathZones, 0xAE0478, 8);
DataArray(LightData, PyramidCave_DefaultLights, 0xAE04C0, 2);
DataPointer(LevelHeader, PyramidCaveHeader, 0xAE0500);
DataPointer(DeathZone, MetalHarbor_DeathZone, 0xB06570);
DataArray(LightData, MetalHarbor_DefaultLights, 0xB06580, 2);
DataPointer(LevelHeader, MetalHarborHeader, 0xB065C0);
DataArray(ObjectListEntry, PoolQuestObjectList, 0xB06750, 111);
DataArray(LightData, PoolQuest_DefaultLights, 0xB09510, 2);
DataPointer(LevelHeader, PoolQuestHeader, 0xB09550);
DataArray(ChunkMapColor, PoolQuest_ChunkColors, 0xB09568, 5);
...
DataPointer(DeathZone, DeathChamber_DeathZone, 0xBAFDA0);
DataArray(LightData, DeathChamber_DefaultLights, 0xBAFDB0, 2);
DataPointer(LevelHeader, DeathChamberHeader, 0xBAFDF0);
DataPointer(AnimationIndex, WildCanyonCharAnims, 0xBB1BE8);
DataPointer(DeathZone, WildCanyon_DeathZone, 0xBED518);
DataArray(LightData, WildCanyon_DefaultLights, 0xBED528, 2);
DataPointer(LevelHeader, WildCanyonHeader, 0xBED568);
DataPointer(AnimationIndex, IronGateCharAnims, 0xC03E38);
DataArray(DeathZone, IronGate_DeathZones, 0xC040D0, 3);
DataArray(LightData, IronGate_DefaultLights, 0xC040F0, 2);
DataPointer(LevelHeader, IronGateHeader, 0xC04130);
DataArray(ChunkMapColor, IronGate_ChunkColors, 0xC04148, 16);
DataArray(AnimationIndex, EggQuartersCharAnims, 0xC3DE88, 15);
DataPointer(DeathZone, EggQuarters_DeathZone, 0xC4F040);
DataArray(LightData, EggQuarters_DefaultLights, 0xC4F050, 2);
DataPointer(LevelHeader, EggQuartersHeader, 0xC4F090);
DataPointer(AnimationIndex, LostColony2PCharAnims, 0xC4FD98);
DataArray(LightData, LostColony2P_DefaultLights, 0xC50A08, 2);
...
DataArray(SummaryDataArray, StorySummaries, 0xC686C0, 50);
DataArray(char**, MasterStringList, 0xC70590, 6);
DataArray(char**, MasterStringListK, 0xC705A8, 6);
DataPointer(LightData, KartRaceMenu_DefaultLight, 0xC70D14);
DataArray(char *, BattleOptions_ptr, 0xC711D8, 4);
DataArray(LightData, BattleScreen_DefaultLights, 0xC72458, 2);
DataArray(LightData, TutorialMenu_DefaultLights, 0xC73AF0, 2);
DataPointer(LightData, SoundTest_DefaultLightA, 0xC73E80);
DataPointer(LightData, SoundTest_DefaultLightB, 0xC74F44);
...
DataArray(MenuBackgrounds, CharacterMenuBackgrounds, 0xC77E50, 22);
DataPointer(MenuData*, StageSelectData, 0xC77F08);
DataPointer(MenuData *, MainMenuData, 0xC77F14);
DataPointer(DeathZone, PlanetQuest_DeathZone, 0xC86D54);
DataArray(LightData, PlanetQuest_DefaultLights, 0xC86D68, 2);
...
DataArray(LightData, TailsVsEggman2_DefaultLights, 0xC8A848, 2);
DataPointer(LevelHeader, TailsVsEggman2Header, 0xC8A888);
DataArray(AnimationIndex, CannonsCoreKCharAnims, 0xCCDEB8, 7);
DataArray(DeathZone, CannonsCoreK_DeathZones, 0xCCE7D0, 2);
DataArray(LightData, CannonsCoreK_DefaultLights, 0xCCE7E8, 2);
DataPointer(LevelHeader, CannonsCoreKHeader, 0xCCE828);
DataArray(AnimationIndex, SandOceanCharAnims, 0xCF9980, 3);
DataArray(DeathZone, SandOcean_DeathZones, 0xCCE7D0, 4);
DataArray(LightData, SandOcean_DefaultLights, 0xD022E8, 2);
DataPointer(LevelHeader, SandOceanHeader, 0xD02328);
DataPointer(DeathZone, HiddenBase2P_DeathZone, 0xD866C4);
DataArray(LightData, HiddenBase2P_DefaultLights, 0xD866D8, 2);
DataPointer(LevelHeader, HiddenBase2PHeader, 0xD86718);
DataPointer(AnimationIndex, MadSpaceCharAnims, 0xD9D948);
DataPointer(DeathZone, MadSpace_DeathZone, 0xDBB114);
DataArray(LightData, MadSpace_DefaultLights, 0xDBB128, 2);
DataPointer(LevelHeader, MadSpaceHeader, 0xDBB168);
DataPointer(DeathZone, MetalHarbor2P_DeathZone, 0xDBDC04);
DataArray(LightData, MetalHarbor2P_DefaultLights, 0xDBDC20, 2);
DataPointer(LevelHeader, MetalHarbor2PHeader, 0xDBDC60);
DataArray(ChunkMapColor, MetalHarbor2P_ChunkColors, 0xDBDC78, 14);
DataPointer(DeathZone, DeathChamber2P_DeathZone, 0xDC8DB8);
DataArray(LightData, DeathChamber2P_DefaultLights, 0xDC8DC8, 2);
DataPointer(LevelHeader, DeathChamber2PHeader, 0xDC8E08);
DataPointer(DeathZone, WeaponsBed2P_DeathZone, 0xDCB6D0);
DataPointer(LevelHeader, WeaponsBed2PHeader, 0xDCB6E4);
DataArray(LightData, KnucklesVsRouge_DefaultLights, 0xDDA128, 2);
DataPointer(LevelHeader, KnucklesVsRougeHeader, 0xDDA168);
DataArray(AnimationIndex, DryLagoonCharAnims, 0xDEA388, 11);
DataPointer(DeathZone, DryLagoon_DeathZone, 0xE5DD9C);
DataArray(LightData, DryLagoon_DefaultLights, 0xE5DDB0, 2);
DataPointer(LevelHeader, DryLagoonHeader, 0xE5DDF0);
DataArray(DeathZone, CannonsCoreT_DeathZones, 0xE71200, 4);
DataArray(LightData, CannonsCoreT_DefaultLights, 0xE71220, 2);
DataPointer(LevelHeader, CannonsCoreTHeader, 0xE71314);
DataPointer(AnimationIndex, SecurityHallCharAnims, 0xE8BA28);
DataPointer(DeathZone, SecurityHall_DeathZone, 0xE8F9B0);
DataArray(LightData, SecurityHall_DefaultLights, 0xE8F9C0, 2);
DataPointer(LevelHeader, SecurityHallHeader, 0xE8FA00);
DataPointer(AnimationIndex, WhiteJungleCharAnims, 0xEA22EC);
DataArray(DeathZone, WhiteJungle_DeathZones, 0xEAE574, 2);
DataArray(LightData, WhiteJungle_DefaultLights, 0xEAE5B0, 2);
DataPointer(LevelHeader, WhiteJungleHeader, 0xEAE5F0);
DataArray(ChunkMapColor, WhiteJungle_ChunkColors, 0xEAE608, 14);
DataPointer(AnimationIndex, CosmicWallCharAnims, 0xEC5438);
DataArray(DeathZone, CosmicWall_DeathZones, 0xEDCCB0, 17);
DataArray(LightData, CosmicWall_DefaultLights, 0xEDCD40, 2);
DataPointer(LevelHeader, CosmicWallHeader, 0xEDCD80);
DataArray(ChunkMapColor, CosmicWall_ChunkColors, 0xEDCD98, 14);
DataPointer(DeathZone, CosmicWall2P_DeathZone, 0xEF2F28);
DataArray(LightData, CosmicWall2P_DefaultLights, 0xEF2F38, 2);
DataPointer(LevelHeader, CosmicWall2PHeader, 0xEF2F78);
DataPointer(DeathZone, TailsVsEggman1_DeathZone, 0xEF46C0);
DataArray(LightData, TailsVsEggman1_DefaultLights, 0xEF46D0, 2);
DataPointer(LevelHeader, TailsVsEggman1Header, 0xEF4710);
DataArray(KartCourse, KartCourseLayouts, 0xEF82BC, 6);
DataPointer(float, KartCPUSpeed, 0xEF82EC);
DataPointer(float, KartCPUVariance, 0xF39E7C);
DataPointer(float, KartCPUAggression, 0xF54DCC);
DataArray(KartPhysics, KartPhysicsArray, 0xFF9EF0, 15);
DataArray(LightData, KartRacing_DefaultLights, 0x100ACB0, 2);
DataPointer(LevelHeader, CartHeader, 0x100ACF0);
DataPointer(DeathZone, SonicVsShadow1_DeathZone, 0x100BD34);
DataArray(LightData, SonicVsShadow1_DefaultLights, 0x100BD68, 2);
...
DataArray(LightData, KingBoomBoo_DefaultLights, 0x1036738, 4);
DataPointer(LevelHeader, KingBoomBooHeader, 0x10367B8);
DataPointer(AnimationIndex, PrisonLaneCharAnims, 0x104BB00);
DataArray(DeathZone, PrisonLane_DeathZones, 0x104C6E4, 3);
DataArray(LightData, PrisonLane_DefaultLights, 0x104C710, 2);
DataArray(ChunkMapColor, PrisonLane_ChunkColors, 0x104C728, 10);
DataPointer(LevelHeader, PrisonLaneHeader, 0x104C750);
DataPointer(LevelHeader, EmblemGetHeader, 0x104C7D0);
DataArray(void*, EventParticleFunctionCalls, 0x104CC28, 18);
DataArray(EventParticleAnimControl, EventParticlePulseData, 0x104CDB0, 13);
DataPointer(LightData, tailsPlain_DefaultLight, 0x104CEE8);
...
DataArray(DeathZone, GreenForest_DeathZones, 0x1089260, 8);
DataArray(LightData, GreenForest_DefaultLights, 0x10892B8, 2); // Unreferenced
DataPointer(LevelHeader, GreenForestHeader, 0x10892F8);
DataArray(ChunkMapColor, GreenForest_ChunkColors, 0x1089330, 13);
DataArray(ObjectListEntry, CityEscape_ObjectArray, 0x109E830, 102);
DataPointer(ObjectListHead, CityEscape_ObjectList, 0x109EE90);
DataArray(DeathZone, CityEscape_DeathZones, 0x10DC678, 3);
DataArray(LightData, CityEscape_DefaultLights, 0x10DC698, 2);
DataPointer(LevelHeader, CityEscapeHeader, 0x10DC6D8);
DataArray(ChunkMapColor, CityEscape1P_ChunkColors, 0x10DC6F0, 17);
DataArray(ChunkMapColor, CityEscape2P_ChunkColors, 0x10DC778, 17);
DataArray(DeathZone, GreenHill_DeathZones, 0x10F2F88, 2);
DataArray(LightData, GreenHill_DefaultLights, 0x10F2FA0, 2);
DataPointer(LevelHeader, GreenHillHeader, 0x10F2FE0);
DataArray(LightData, FlyingDog_DefaultLights, 0x113AA20, 3);
DataPointer(LevelHeader, FlyingDogHeader, 0x113AA80);
DataArray(LightData, BigFoot_DefaultLights, 0x113AA98, 3);
DataPointer(LevelHeader, BigFootHeader, 0x113AAF8);
DataPointer(LevelHeader, HotShotHeader, 0x113AB10);
DataArray(LightData, HotShot_DefaultLights, 0x113AB28, 3);
DataPointer(AnimationIndex, MeteorHerdCharAnims, 0x1155830);
DataPointer(DeathZone, MeteorHerd_DeathZone, 0x1165250);
DataArray(LightData, MeteorHerd_DefaultLights, 0x1165260, 2);
DataPointer(LevelHeader, MeteorHerdHeader, 0x11652A0);
DataPointer(AnimationIndex, SkyRailCharAnims, 0x117A290);
DataArray(DeathZone, SkyRail_DeathZones, 0x117F6E8, 4);
DataArray(LightData, SkyRail_DefaultLights, 0x117F710, 2);
DataPointer(LevelHeader, SkyRailHeader, 0x117F750);
DataArray(ChunkMapColor, SkyRail_ChunkColors, 0x117F768, 9);
DataPointer(AnimationIndex, MissionStreetCharAnims, 0x11B7F54);
DataArray(DeathZone, MissionStreet_DeathZones, 0x11BA410, 10);
DataArray(LightData, MissionStreet_DefaultLights, 0x11BA468, 2);
DataPointer(LevelHeader, MissionStreetHeader, 0x11BA4A8);
DataArray(ChunkMapColor, MissionStreet_ChunkColors, 0x11BA4C0, 9);
...
DataArray(LightData, ChaoKindergarten_DefaultLights, 0x1313670, 2);
DataArray(LightData, ChaoStadium_DefaultLights, 0x1313728, 2);
DataArray(LightData, ChaoRaceEntrance_DefaultLights, 0x13137B8, 2);
DataArray(LightData, HeroGarden_DefaultLights, 0x13139E8, 2);
DataArray(LightData, ChaoGarden_DefaultLights, 0x1313CE8, 2);
DataArray(LightData, ChaoWorldLobby_DefaultLights, 0x1313ED0, 2);
DataArray(LightData, ChaoTransporter_DefaultLights, 0x1314060, 2);
DataArray(LightData, DarkGarden_DefaultLights, 0x13141E8, 2);
...
DataArray(LightData, ChaoKarate_DefaultLights, 0x1366DE0, 3);
DataArray(LightData, ChaoRace_DefaultLights, 0x1366F60, 2);
...
DataArray(DeathZone, IronGate2P_DeathZones, 0x1369710, 3);
DataArray(LightData, IronGate2P_DefaultLights, 0x1369730, 2);
...
DataArray(LightData, Biolizard_DefaultLights, 0x1406F48, 5);
...
DataArray(LightData, DowntownRace_DefaultLights, 0x14090A0, 2);
DataPointer(LevelHeader, DowntownRaceHeader, 0x14090E0);
DataArray(ChunkMapColor, DowntownRace_ChunkColors, 0x14090F8, 10);
...
DataPointer(DeathZone, SandOcean2P_DeathZone, 0x14157FC);
...
DataArray(DeathZone, GrindRace_DeathZones, 0x1445710, 21);
DataArray(LightData, GrindRace_DefaultLights, 0x14457C0, 2);
...
DataArray(DeathZone, CannonsCoreEggman_DeathZones, 0x145CFC8, 3);
DataArray(LightData, CannonsCoreEggman_DefaultLights, 0x145D270, 2);
...
DataArray(DeathZone, FinalChase_DeathZones, 0x1553AE0, 6);
DataArray(LightData, FinalChase_DefaultLights, 0x1553B18, 2);
DataPointer(LevelHeader, FinalChaseHeader, 0x1553B58);
DataArray(ChunkMapColor, FinalChase_ChunkColors, 0x1553B70, 17);
...
DataPointer(DeathZone, DryLagoon2P_DeathZone, 0x156C0C4);
DataArray(LightData, DryLagoon2P_DefaultLights, 0x156C0F8, 2);
...
DataArray(DeathZone, RadicalHighway_DeathZones, 0x15A28A0, 16);
DataArray(LightData, RadicalHighway_DefaultLights, 0x15A2928, 2);
DataPointer(LevelHeader, RadicalHighwayHeader, 0x15A2968);
DataArray(ChunkMapColor, RadicalHighway_ChunkColors, 0x15A2980, 9);
DataPointer(ObjectListEntry, PyramidRace_ObjecArray, 0x15A7120);
DataPointer(ObjectListHead, PyramidRace_ObjecList, 0x15A76B0);
DataArray(LightData, PyramidRace_DefaultLights, 0x15A87B0, 2);
...
DataArray(DeathZone, CannonsCoreR_DeathZones, 0x1613B2C, 2);
DataArray(LightData, CannonsCoreR_DefaultLights, 0x1613B48, 2);
...
DataArray(LightData, AquaticMine_DefaultLights, 0x163B520, 2);
DataPointer(LevelHeader, AquaticMineHeader, 0x163B560);
DataArray(ChunkMapColor, AquaticMine_ChunkColors, 0x163B578, 5);
...
DataArray(DeathZone, CannonsCoreS_DeathZones, 0x1650E54, 4);
DataArray(LightData, CannonsCoreS_DefaultLights, 0x1650E80, 2);
...
DataPointer(DeathZone, EggGolem_DeathZone, 0x166F088);
DataArray(LightData, EggGolem_DefaultLights, 0x166F098, 2);
DataPointer(LevelHeader, EggGolemHeader, 0x166F0D8);
DataArray(LightData, EternalEngine2P_DefaultLights, 0x16725A0, 2);
...
DataPointer(DeathZone, WildCanyon2P_DeathZone, 0x1676570);
DataArray(LightData, WildCanyon2P_DefaultLights, 0x1676580, 2);
...
DataPointer(DeathZone, PumpkinHill_DeathZone, 0x168B944);
DataArray(LightData, PumpkinHill_DefaultLights, 0x168B960, 2);
...
DataArray(DeathZone, FinalRush_DeathZones, 0x16C6C70, 18);
DataArray(LightData, FinalRush_DefaultLights, 0x16C6D08, 2);
DataPointer(LevelHeader, FinalRushHeader, 0x16C6D48);
DataArray(ChunkMapColor, FinalRush_ChunkColors, 0x16C6D60, 18);
...
DataPointer(DeathZone, EggGolemE_DeathZone, 0x162DA78);
DataArray(LightData, EggGolemE_DefaultLights, 0x16D2A88, 2);
...
DataArray(LightData, FinalHazard_DefaultLights, 0x170ED80, 4);
DataPointer(LevelHeader, FinalHazardHeader, 0x170EDB0);
DataArray(CutsceneVoices, CutsceneMasterVoiceList, 0x1716720, 720);
...
DataArray(StoryEntry, SonicTrialDemoSequence, 0x1730074, 3); // Leftover level sequence from demo versions of the game
DataArray(StoryEntry, SonicPreviewDemoSequence, 0x173089C, 3); // Leftover level sequence from demo versions of the game
DataArray(StoryEntry, KnucklesDemoSequence, 0x1730AC4, 3); // Leftover level sequence from demo versions of the game
DataArray(StoryEntry, ShadowDemoSequence, 0x17312EC, 3); // Leftover level sequence from demo versions of the game
DataArray(StoryEntry, RougeDemoSequence, 0x17318CC, 3); // Leftover level sequence from demo versions of the game
DataArray(VersusIntroData, VersusModeIntroData, 0x1738A80, 17);
DataArray(int, VersusModeIntroIdleAnimIDs, 0x1738C18, 17);
DataArray(IdleVoiceArray, StageIdleVoices, 0x1738C68, 40);
DataArray(IdleVoiceArray, GenericIdleVoices, 0x1738D58, 8);
...
DataArray(StoryEntry, HeroStoryEntries, 0x173A148, 48);
DataArray(StoryEntry, DarkStoryEntries, 0x173A370, 44);
DataArray(StoryEntry, LastEpisodeStoryEntries, 0x173A580, 8);
DataArray(StoryEntry, IntroStoryEntries, 0x173A5E0, 2);
DataArray(StoryEntry, TailsDemoStoryEntries, 0x173A5F8, 2); // Leftover level sequence from demo versions of the game
DataArray(StoryEntry, EggmanDemoStoryEntries, 0x173A610, 2); // Leftover level sequence from demo versions of the game
...
DataArray(StoryEntry, DCIntroStoryEntries, 0x173A7EC, 2); // Unused
DataArray(LevelCutscene, MiniEventLoadArray, 0x173A808, 15);
...
DataArray(Mission4TimeLimits, Mission4ClearTimes, 0x173B318, 30);
...
DataArray(int, InputMode, 0x174B5FC, 4);
...
DataArray(CheckpointRespawnData, CheckpointRecords, 0x1934B88, 2);
...
DataPointer(NJS_MATRIX, SuperShadowLHeelFlameMatrix, 0x19EE000);
DataPointer(NJS_MATRIX, SuperShadowRHeelFlameMatrix, 0x19EE030);
DataPointer(NJS_MATRIX, SuperShadowLToeFlameMatrix, 0x19EE060);
DataPointer(NJS_MATRIX, Super_RightFootMatrix, 0x19EE090);
DataPointer(NJS_MATRIX, SuperMasterMatrix, 0x19EE0C0);
DataPointer(NJS_MATRIX, Super_RightHandMatrix, 0x19EE0F0);
DataPointer(NJS_MATRIX, Super_LeftFootMatrix, 0x19EE120);
DataPointer(SuperSonicCharObj2*, SuperSonicCO2PtrExtern, 0x19EE150);
DataPointer(NJS_MATRIX, Super_LeftHandMatrix, 0x19EE154);
DataArray(NJS_OBJECT*, SuperSonicHeadTrackingModels, 0x19EE184, 3);
DataArray(NJS_OBJECT*, SuperShadowHeadTrackingModels, 0x19EE190, 3);
DataPointer(NJS_MATRIX, SuperShadowRToeFlameMatrix, 0x19EE19C);
...
DataPointer(char*, EventVideoName, 0x1A28E58);
DataPointer(float, EventVideoDepth, 0x1A28E60);
...
DataPointer(NJS_MATRIX, MetalSonicJetMatrix, 0x1A51858);
DataArray(NJS_OBJECT*, ShadowHeadTrackingModels, 0x1A51888, 3);
DataPointer(NJS_MATRIX, MATRIX_AIRSHOE_R, 0x1A51894);
DataPointer(NJS_MATRIX, MetalSonicBlackShieldMatrix, 0x1A518C4);
DataArray(NJS_OBJECT*, MetalSonicHeadTrackingModels, 0x1A518F4, 3);
DataPointer(NJS_MATRIX, ShadowLHeelFlameMatrix, 0x1A51900);
DataPointer(NJS_MATRIX, ShadowRHeelFlameMatrix, 0x1A51930);
DataPointer(int, SonicGravityAngle_X, 0x1A51960);
DataPointer(NJS_MATRIX, AmyRightHeelMatrix, 0x1A51964);
DataPointer(NJS_MATRIX, ShadowLToeFlameMatrix, 0x1A51994);
DataArray(NJS_OBJECT*, AmyHeadTrackingModels, 0x1A519C4, 3);
DataPointer(NJS_MATRIX, SpeedCharacterMasterMatrix, 0x1A51A00);
...
DataArray(NJS_OBJECT*, SonicHeadTrackingModels, 0x1A51AD0, 3);
DataPointer(NJS_MATRIX, ShadowRToeFlameMatrix, 0x1A51ADC);
DataPointer(NJS_MATRIX, RougeWingMatrix, 0x1A51B0C);
DataPointer(NJS_MATRIX, KnucklesAirNecklaceMatrix, 0x1A51B3C);
DataArray(NJS_OBJECT*, RougeHeadTrackingModels, 0x1A51B6C, 3);
DataPointer(Angle, KnucklesGravityAngle_Z, 0x1A51B78);
DataPointer(NJS_MATRIX, RougeWingShadowMatrix, 0x1A51B7C);
DataArray(NJS_OBJECT*, KnucklesHeadTrackingModels, 0x1A51BAC, 3);
DataPointer(Angle, KnucklesGravityAngle_X, 0x1A51BB8);
DataPointer(NJS_MATRIX, RougePickNailsLMatrix, 0x1A51BBC);
DataPointer(NJS_MATRIX, HuntingCharacterMasterMatrix, 0x1A51BEC);
DataPointer(NJS_MATRIX, RougePickNailsRMatrix, 0x1A51C1C);
DataPointer(NJS_VECTOR, KnucklesGravity, 0x1A51C4C);
DataPointer(NJS_MATRIX, HuntingRUpgradeMatrix, 0x1A51C58);
DataPointer(KnucklesCharObj2*, KnucklesCO2PtrExtern, 0x1A51C88);
DataPointer(NJS_MATRIX, HuntingLUpgradeMatrix, 0x1A51C8C);
DataPointer(NJS_MATRIX, HuntingHeadUpgradeMatrix, 0x1A51CBC);
DataArray(NJS_OBJECT*, TikalHeadTrackingModels, 0x1A51CEC, 3);
DataPointer(NJS_MATRIX, EggmanMasterMatrix, 0x1A51CF8);
DataPointer(EggmanCharObj2*, EggmanCO2PtrExtern, 0x1A51D28);
DataPointer(NJS_MATRIX, MechEggmanCannonMatrix, 0x1A51D2C);
DataPointer(NJS_MATRIX, ChaoWalkerJetRMatrix, 0x1A51D5C);
DataPointer(NJS_MATRIX, ChaoWalkerJetLMatrix, 0x1A51D8C);
DataPointer(NJS_MATRIX, DarkChaoWalkerCannonMatrix, 0x1A51DBC);
DataPointer(NJS_MATRIX, DarkChaoWalkerJetRMatrix, 0x1A51DEC);
DataPointer(NJS_MATRIX, ChaoWalkerCannonMatrix, 0x1A51E1C);
DataPointer(NJS_MATRIX, MechTailsBoosterLMatrix, 0x1A51E4C);
DataPointer(NJS_MATRIX, DarkChaoWalkerTopAccesoryMatrix, 0x1A51E7C);
DataPointer(NJS_MATRIX, MechBlasterMatrix, 0x1A51EAC);
DataPointer(NJS_MATRIX, MechTailsBoosterRMatrix, 0x1A51EDC);
DataPointer(MechEggmanCharObj2*, MechEggmanCO2PtrExtern, 0x1A51F0C);
DataPointer(NJS_MATRIX, MechTailsTopAccessoryMatrix, 0x1A51F10);
DataPointer(NJS_MATRIX, DarkChaoWalkerBottomAccessoryMatrix, 0x1A51F40);
DataPointer(NJS_MATRIX, MechCharacterMasterMatrix, 0x1A51F70);
DataPointer(NJS_MATRIX, ChaoWalkerBottomAccessoryMatrix, 0x1A51FA0);
DataPointer(NJS_MATRIX, DarkChaoWalkerJetLMatrix, 0x1A51FD0);
DataPointer(NJS_MATRIX, MechEggmanJetRMatrix, 0x1A52000);
DataPointer(NJS_MATRIX, MechTailsCannonMatrix, 0x1A52030);
DataPointer(NJS_MATRIX, MechEggmanJetLMatrix, 0x1A52060);
DataPointer(NJS_MATRIX, MechEggmanBottomAccessoryMatrix, 0x1A52090);
DataPointer(NJS_MATRIX, MechEggmanTopAccessoryMatrix, 0x1A520C0);
DataPointer(NJS_MATRIX, MechTailsAccessoryMatrix, 0x1A520F0);
DataPointer(NJS_MATRIX, ChaoWalkerTopAccessoryMatrix, 0x1A52120);
DataArray(NJS_OBJECT*, TailsHeadTrackingModels, 0x1A52150, 3);
DataPointer(NJS_MATRIX, TailsTailsMatrix, 0x1A5215C);
DataPointer(NJS_MATRIX, TailsTailShadowMatrix, 0x1A5218C);
DataPointer(NJS_MATRIX, TailsMasterMatrix, 0x1A521BC);
...
DataPointer(ModelFuncPtr, CurrentDrawCallBack, 0x1A55834);
DataPointer(ObjectMaster*, CounterOfDestructedEnemy_ptr, 0x1A5A1F0);
DataPointer(ObjectMaster*, CardIndicatorExec_ptr, 0x1A5A220);
DataPointer(NJS_VECTOR*, PlayerPositionHistory, 0x1A5A234);
DataPointer(NJS_VECTOR*, PlayerRotationHistory, 0x1A5A238);
...
DataPointer(DeathZone, EternalEngine2P_DeathZone, 0x1A5A4F8);
DataPointer(DeathZone, SonicVsShadow2_DeathZone, 0x1A5A624);
...
DataPointer(DeathZone, DowntownRace_DeathZone, 0x1A5AE60);
...
DataPointer(DeathZone, TailsVsEggman2_DeathZone, 0x1AEE2C0);
...
DataPointer(DeathZone, LostColony2P_DeathZone, 0x1AEFBF0);
...
DataPointer(char*, HintTextFile, 0x1AF0170);
...
DataArray(EggQuartersPatrolBug*, EggQuartersPatrolBugs, 0x1D1B770, 2);
DataArray(NJS_POINT3, EggQuartersPatrolBugPositions, 0x1D1B780, 2);
...
DataPointer(int, KartCourseID, 0x1D970FC);
DataPointer(KartDownloadData, KartDLCData, 0x1D97100);
DataArray(char, SomeSFDStrings, 0x1DB0C00, 568);
DataPointer(float, EventOverallFrame, 0x1DB0FC0);
DataPointer(int, EventSceneNumber, 0x1DB0FC8);
DataPointer(int, EventID, 0x1DB0FCC);
DataPointer(CutsceneAssetArray*, EventSceneAssets, 0x1DB0FD4);
...
DataArray(bool, SwitchPressedStates, 0x1DE9460, 32);
...
DataArray(char, IsThings, 0x1DEFDA0, 4);
