...
DataArray(ChunkMapColor, EternalEngine_ChunkMaps, 0x9A15D0, 13);
...
DataArray(ChunkMapColor, CrazyGadget_ChunkMaps, 0x9C8220, 13);
...
DataArray(DeathZone, CannonsCoreK_DeathZone, 0xCCE7D0, 2);
...
DataArray(LightData, KartRacing_DefaultLights, 0x10ACB0, 2);
...
DataArray(LightData, HotShot_DefaultLights, 0x113AB28, 2);
